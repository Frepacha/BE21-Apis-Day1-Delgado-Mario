...
function curl_get($url) {
    ...
    //PHP.net: true um den Transfer als String zurückzuliefern, anstatt ihn direkt auszugeben,
    //false: wird als Objekt ausgegeben, aufpassen bei  $response = curl_exec($client);
